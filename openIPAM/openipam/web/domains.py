...
class Domains(BasePage):
    ...
    def domain_form(self, action_string="Add", did=0):
        ...
        form = (
            '''<form action="/dns/process_domain" method="post" class="form">
                <div id="element">
            ...
            + '''" /></div>
                ...
                <div id="element">
                    ...
                    <div id="value"><input type="text" class="text" name="master" value="'''
            + domain["master"]
            + '''" /></div>
                </div>
                <div id="element">
                    <div id="label">Type:</div>
                    <div id="value"><input type="text" class="text" name="type" value="'''
            + domain["type"]
            + '''" /></div>
                </div>
    ...
    def process_domain(self, **kw):
        ...
        if int(kw["did"]) == 0:
            ...
            try:
                args = {"name": kw["name"], "master": kw["master"], "type": kw["type"]}
