        ...
        for link in self.__links:
            if self.__values[counter] == self.__selected:
                text.append(
                    ...
                    % (link, self.__values[counter])
                )
            else:
                text.append(
                    '<li><a href="%s">%s</a></li>' % (link, self.__values[counter])
                )
            counter += 1
    ...
    def __str__(self):
        ...
        for link in self.__links:
            if self.__selected[counter]:
                ...
                text.append(
                    '<li><a href="%s">%s</a></li>' % (link, self.__values[counter][1])
                )
            else:
                text.append(
                    '<li><a href="%s">%s</a></li>' % (link, self.__values[counter][0])
                )
            counter += 1
