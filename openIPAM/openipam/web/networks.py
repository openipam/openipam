...
class Networks(BasePage):
    ...
    def network_form(self, action_string="Add", nid=0):
        ...
        form = (
            '''<form action="/networks/process_network" method="post" class="form">
                      <div id="element">
                             <div id="label">Network (CIDR)*:</div>
                             <div id="value"><input type="text" class="text" name="network" value="'''
            + network["network"]
            + '''" /></div>
                      </div>
                      <div id="element">
            ...
            + '''" /></div>
                      ...
                      <div id="element">
                             ...
                             <div id="value"><input type="text" class="text" name="gateway" value="'''
            + network["gateway"]
            + """" /></div>
                      </div>
                      <div id="element">
    ...
    def index(self):
        ...
        maincontent = (
            """<h1>Networks</h1><div class="message">Under construction.</div>""" + info
        )
    ...
    def add(self):
        ...
        maincontent = (
            '<h1>Add Network</h1><div class="message">Under construction.</div>%s'
            % self.network_form()
        )
